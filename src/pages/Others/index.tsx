...
const Others: React.FC = () => {
  ...
  const [others, setOthers] = useState<projectType[]>([]);
  ...
  useEffect(() => {
    const filteredOthersProjects = projects.filter(
      (project) => project.category === "Outros"
    );
    setOthers(filteredOthersProjects);
  }, [projects]);
                  ...
                  <div className="col" key={project.id}>
                    <div className="card shadow-sm h-100">
                      ...
                      <div className="card-body border secondary">
                        ...
                        <a className="category-link card-text" href={"/others"}>
