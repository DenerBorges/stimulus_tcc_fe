...
const Gastronomy: React.FC = () => {
  ...
  const [gastronomy, setGastronomy] = useState<projectType[]>([]);
  ...
  useEffect(() => {
    const filteredGastronomyProjects = projects.filter(
      (project) => project.category === "Gastronomia"
    );
    setGastronomy(filteredGastronomyProjects);
  }, [projects]);
  ...
  return (
    <>
      ...
      <h1 className="text-center shadow fw-bolder py-2 my-3">
        Projetos da categoria gastronomia
      </h1>
