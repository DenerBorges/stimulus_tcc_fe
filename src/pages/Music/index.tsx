...
const Music: React.FC = () => {
  ...
  const [music, setMusic] = useState<projectType[]>([]);
  ...
  useEffect(() => {
    const filteredMusicProjects = projects.filter(
      (project) => project.category === "Música"
    );
    setMusic(filteredMusicProjects);
  }, [projects]);
                  ...
                  <div className="col" key={project.id}>
                    <div className="card shadow-sm h-100">
                      ...
                      <div className="card-body border secondary">
                        ...
                        <a className="category-link card-text" href={"/music"}>
