  ...
  return (
    <>
      ...
      <div className="page-container">
        ...
        <div className="main-content container row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 mb-5 mx-auto my-auto">
          <div className="col">
          ...
          <div className="col">
            <div className="catcard card pt-4 h-100">
              <a href="/social" className="text-dark">
                <img
                  src={require("../../assets/images/categorie_social.png")}
                  className="card-img"
                  alt="Social"
                />
                <div className="card-img-overlay">
                  <h3 className="text-center fw-bolder">Social</h3>
                </div>
              </a>
            </div>
          </div>
